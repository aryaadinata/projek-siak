...
class Admin extends BaseController
{
    ...
    function ambildata1()
    {
        if ($this->request->isAJAX()) {
            ...
            $siswaModel = new SiswaModel();
            $siswa = $siswaModel->getSiswaByParameters("", "", $id_kelas);
            $data = [
                'siswa' => $siswa,
            ];
            $msg = [
    ...
    {
        if ($this->request->isAJAX()) {
            $id_tingkat = $this->request->getVar('id_kelas');
            $id_kelas = $this->request->getVar('id_kelas');
            $id_jurusan = $this->request->getVar('id_kelas');
            $siswaModel = new SiswaModel();
            $siswa = $siswaModel->getSiswaByParameters("", "", "");
            $data = [
                'siswa' => $siswa,
            ];
            $msg = [
    ...
    function ambildatalulus()
    {
        if ($this->request->isAJAX()) {
            ...
            $siswaModel = new SiswaModel();
            $siswa = $siswaModel->ambildatalulus($id_tahun);
            $data = [
                'siswa' => $siswa,
            ];
            $msg = [
    ...
    function modalsiswa()
    {
        if ($this->request->isAJAX()) {
            $id_kelas = $this->request->getVar('id_kelas');
            $siswaModel = new SiswaModel();
            $siswa = $siswaModel->siswajoinkelas($id_kelas);
    ...
    function ambilbiodata($nis)
    {
        if ($this->request->isAJAX()) {
            $siswaModel = new SiswaModel();
            $siswa = $siswaModel->biodatasiswa($nis);
    ...
    function ambiltahun()
    {
        if ($this->request->isAJAX()) {
            $tahunModel = new TahunModel();
            $tahunAjaran = $tahunModel->orderBy('tahun_awal', 'ASC')->findAll();
            $data = [
    ...
    function updatetahun()
    {
        ...
        $valid = $this->validate([
            'tahun_awal' => [
                'label' => "Tahun Awal",
                'rules' => "required|is_unique[tahun_ajaran.tahun_awal,id_tahun," . $this->request->getVar('id_tahun') . "]",
                'errors' => [
                    'required' => '{field} tidak boleh kosong',
                    'is_unique' => '{field} sudah ada !'
                ]
    ...
    public function kenaikan()
    {
        ...
        $userInfo = $userModel->find($loggedAdmin);
        $kelasModel = new KelasModel();
        $kelasasal = $kelasModel->orderBy('id_tingkat, nama_kelas', 'ASC')->findAll();
        $data = [
            'title' => "Rombel",
            'userInfo' => $userInfo,
            'kelasasal' => $kelasasal,
    ...
    public function kelulusan()
    {
        ...
        $userInfo = $userModel->find($loggedAdmin);
        $kelasModel = new KelasModel();
        $kelas = $kelasModel->getKelasByTingkat(3);
    ...
    function ambilkelas()
    {
        if ($this->request->isAJAX()) {
            $kelasModel = new KelasModel();
            $kelasInfo = $kelasModel->getJoinedData();
            $data = [
                'kelas' => $kelasInfo
            ];
            $msg = [
    ...
    function formtambahKelas()
    {
        ...
        $wali = $ptkModel->where('jenis_ptk', 0)->findAll();
        $data = [
            'jurusan' => $jurusan,
            'wali' => $wali,
        ];
    ...
    public function pilihkelas()
    {
        if ($this->request->isAJAX()) {
            ...
            $kelasModel = new KelasModel();
            $kelas = $kelasModel->getKelasByJurusanTingkat($id_jurusan, $id_tingkat);
            $data = "<option value='0'>--Pilih Kelas--</option>";
