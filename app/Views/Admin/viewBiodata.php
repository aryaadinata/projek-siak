        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="text-center">
              <?php if ($siswa["foto"] != "") : ?>
                <img class="rounded img-fluid" src="<?= base_url() ?>dist/img/pasfoto/<?= $siswa["foto"]; ?>" alt="Photo" height="320" width="160">
              <?php else : ?>
                <img class="rounded img-fluid" src="<?= base_url() ?>dist/img/pasfoto/none.jpg" alt="Photo" height="320" width="160">
              <?php endif ?>
            </div>
            <p></p>
