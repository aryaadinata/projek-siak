        ...
        <div class="card card-default">
          <div class="card-header d-flex p-0">
            ...
            <ul class="nav nav-pills ml-auto p-2">
              <li class="nav-item">
                <a href="<?php if ($title == "Detail Guru") echo base_url() . "/dataguru";
                          else echo base_url() . "/datapegawai"; ?>" id="btnKembali" class="btn btn-flat nav-link bg-gray"><i class=" fas fa-arrow-left"></i> Kembali</a>
              </li>
              <li class="nav-item btn-primary">
                <button type="button" class="btn nav-link btn-flat bg-pink tomboledit" onclick="edit('<?php echo $ptk['nik_ptk'] ?>')"><i class=" fas fa-pencil-alt"></i> Edit PTK</button>
              </li>
            </ul>
          </div>
          <!-- /.card-header -->
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <div class="custom-file">
                ...
                <input type="hidden" name="nik_en" value="<?= $ptk["nik_en"] ?>">
...
<script>
  function detailptk() {
    $.ajax({
      type: "post",
      url: "<?= base_url('Ptk/ambildetailptk/') ?><?= $ptk["nik_ptk"] ?>",
      dataType: "json",
      beforeSend: function() {
