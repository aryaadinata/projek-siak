             ...
             <div class="card-header d-flex p-0">
               ...
               <ul class="nav nav-pills ml-auto p-2">
                 ...
                 <li class="nav-item btn-info">
                   <a type="button" href="<?php if ($title == "Data Guru") echo base_url('importguru');
                                          else echo base_url('importpegawai'); ?>" class="btn nav-link" style="color:aliceblue"><i class="fas fa-file-import"></i> Import</a>
                 </li>
               </ul>
             </div>
             <!-- /.card-header -->
